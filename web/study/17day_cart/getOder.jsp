...
<script type="text/javascript">
	...
	function chageLangSelect() {
		var str = 'mem_id 입력대기중..';
		var content;
		content = prompt('메시지창', str);
	}
...
<form name="fm" action="post">
	<table class="table_buttons">
		<tr>
			<td>
			<select name="serch">
				<option value="select_allmember" onchange="chageLangSelect()" >회원조회</option>
				<option value="select_members">전체조회</option>
			</select>
