...
<%	// 5. 출력
 ...
 %>
	...
	<!-- 
	 ...
	 <input type="button"	name="update"	 value="수정하기(get)" onclick= "goUpdateFrom_get('<%=mem_id %>')" /> || 
	 <input type="button"	name="update"	 value="수정하기(post)" onclick= "goUpdateFrom_post('<%=mem_id %>')" /> || 
	 <input type="button"	name="delete"	 value="삭제하기(get)" onclick= "goDelete_get('<%=mem_id %>')"  /> ||
	 <input type="button"	name="delete"	 value="삭제하기(post)" onclick= "goDelete_post('<%=mem_id %>')"  /> ||
