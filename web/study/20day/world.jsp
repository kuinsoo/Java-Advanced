...
<div id="product_container">
    <div id="products">
        <div class="product"> <img class="img_100" src="./image/world1.png" /></div>
        <div class="product"> <img class="img_100" src="./image/world2.png" /></div>
        <div class="product"> <img class="img_100" src="./image/world3.png" /></div>
        <div class="product"> <img class="img_100" src="./image/world4.png" /></div>
    </div>
</div>
<% } %>
</body>
